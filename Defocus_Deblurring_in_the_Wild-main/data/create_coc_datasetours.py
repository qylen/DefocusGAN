...
class TrainDataset(Dataset):
    def __init__(self, trainopt):
        ...
        if not os.path.exists(trainpairs_forreading):
            ...
            self.uegt_imgs = {}
            for l_img, r_img, gt_img,cs_img in zip(left_imgs, right_imgs, combine_imgs,combine_source_imgs):
                self.uegt_imgs[gt_img] = [l_img, r_img,cs_img]
    ...
    def __getitem__(self, index):
        ...
        return l_img, r_img,gt_img,cs_img
