...
parser.add_argument('-opt', type=str, default='/home/zjc/dual_pixel/Defocus_Deblurring_in_the_Wild-main/option/test/COC_Dataset_Test.yaml', help='Defocus Deblur: Path to option ymal file.')
...
for test_data in tqdm(test_loader):
    with torch.no_grad():
        ...
        recover = model(x)[0]
        # Save ground truth
        img_dir = "/home/zjc/DataSet/dd_dp_dataset_canon/val_Gb/source/"
